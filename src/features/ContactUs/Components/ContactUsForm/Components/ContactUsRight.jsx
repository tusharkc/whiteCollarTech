    ...
    <div className="bg-[#F7F7F7] max-w-2xl rounded-2xl">
      <div className="p-7">
        ...
        <p className="font-light">
          ...
          All you have to do is take the first step of filling out this form for
          us and we’ll reach out very soon.
        </p>
        ...
        <div className="mt-16">
          ...
          <button className="bg-[#0055A5] text-white hover:bg-[#141414] px-4 py-2 rounded-lg transition-all">
            Submit
          </button>
        </div>
      </div>
