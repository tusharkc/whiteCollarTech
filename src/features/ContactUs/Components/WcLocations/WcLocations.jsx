...
const WcLocations = () => {
  return (
    <div className="mx-36 mt-48">
      ...
      <h2 className="font-light text-[45px] text-center">Our other offices</h2>
