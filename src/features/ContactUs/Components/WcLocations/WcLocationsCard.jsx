  ...
  return (
    <>
      <div class="relative w-full overflow-hidden bg-cover bg-no-repeat">
        <img src={imgSrc} class="w-full max-h-44 sm:max-h-full" alt="Louvre" />
        ...
        <p className="absolute bottom-0 font-light text-3xl sm:text-[40px] text-white p-4">
          {state}, <br className="hidden sm:block" /> {country}
        </p>
      </div>
    </>
  );
